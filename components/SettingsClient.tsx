...
const languages = [
  { name: "English", code: "English", flagUrl: "/flags/gb.png" },
  { name: "Hindi", code: "Hindi", flagUrl: "/flags/in.png" },
  { name: "Spanish", code: "Spanish", flagUrl: "/flags/es.png" },
  { name: "French", code: "French", flagUrl: "/flags/fr.png" },
];
